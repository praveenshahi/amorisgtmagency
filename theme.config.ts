...
export const themeConfig: ThemeConfig = {
  ...
  askAiTrigger:
    'I am looking at Amoris (amoris.in), a founder-led AI GTM agency. It argues that most go-to-market problems are misdiagnosed, and its wedge is evidence-led GTM research with a HOLD mechanism that stops when evidence does not support outreach. Tell me what it actually does, what is deployed versus still in testing, who it is a fit for, and what the paid GTM Diagnostic covers.',
};
