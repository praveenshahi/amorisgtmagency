...
draft: false
question: 'What does the GTM Diagnostic cover'
category: 'engagement'
llmsTxt: true
---

The GTM Diagnostic is a **paid, written diagnosis — from $500, delivered in about two to three days.**
...
**Why "from".** Where you land depends on what the diagnosis has to work through. A clean, documented stack with one source of truth sits at the lower end. Several disconnected tools, patchy pipeline data and no clear owner takes materially longer to untangle. You are told which before anything starts.
...
Separate from this, there is a **free intro call**. It is short, and its only job is to work out whether a diagnosis is worth doing at all. Some conversations end there, which is a fine outcome.
